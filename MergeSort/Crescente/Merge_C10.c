...
int main() {
    ...
    // Preenche o vetor com 1000 valores em ordem crescente
    for (vAux = 0; vAux < TAM; vAux++) {
        vVetor[vAux] = vAux + 1; // Adicionando números de 1 a 1000
    }
    ...
    printf("\n\nValores ordenados pelo Merge Sort (em ordem crescente):\n");
    imprimir(vVetor, TAM);
